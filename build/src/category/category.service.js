...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.findOne = function (name, id) {
        return __awaiter(this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CategoryService.prototype.create = function (catArg) {
        return __awaiter(this, void 0, void 0, function () {
            var err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.categoryRepository.save(catArg)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        err_3 = _a.sent();
    ...
    CategoryService.prototype.update = function (catArg) {
        return __awaiter(this, void 0, void 0, function () {
            var catObj, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        return [4 /*yield*/, this.categoryRepository.findOne(catArg.id)];
                    case 1:
                        catObj = _a.sent();
                        if (!!catObj) return [3 /*break*/, 2];
                        return [2 /*return*/];
                    case 2:
                        catObj.name = catArg.name;
                        return [4 /*yield*/, this.categoryRepository.save(catObj)];
